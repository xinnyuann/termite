...
unzip $jar_folder/jquery-master.zip jquery-master/MIT-LICENSE.txt -d $jar_folder
mv $jar_folder/jquery-master/MIT-LICENSE.txt $jar_folder/LICENSE-jquery
...
unzip $jar_folder/underscore.zip underscore-master/underscore.js -d $jar_folder
unzip $jar_folder/underscore.zip underscore-master/underscore-min.js -d $jar_folder
...
unzip $jar_folder/underscore.zip underscore-master/LICENSE -d $jar_folder
...
unzip $jar_folder/backbone.zip backbone-master/backbone.js -d $jar_folder
unzip $jar_folder/backbone.zip backbone-master/backbone-min.js -d $jar_folder
...
unzip $jar_folder/backbone.zip backbone-master/LICENSE -d $jar_folder
